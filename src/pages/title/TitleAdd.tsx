...
const schema = yup.object({
  _id: yup.string().trim().required("Mã chức danh đã tồn tại!"),
  name: yup.string().trim().required("Tên chức danh không được để trống!"),
  description: yup
    .string()
    .trim()
    .required("Mô tả chức danh không được để trống!"),
});
  ...
  return (
    <Layout>
      <div className="relative h-full">
        <Heading>Thêm chức danh</Heading>
