...
export const headingCancelling = createSlice({
    name: "headingCancelling",
    initialState: {
...
export const { setSelectedHeadings, resetHeadings } = headingCancelling.actions;
export default headingCancelling.reducer;
